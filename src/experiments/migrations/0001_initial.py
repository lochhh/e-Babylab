# Generated by Django 3.1.14 on 2025-09-28 15:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "exp_name",
                    models.CharField(max_length=200, verbose_name="experiment name"),
                ),
                (
                    "created_on",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("OWN", "Only me"),
                            ("GRP", "Group members only"),
                            ("PUB", "Everyone"),
                        ],
                        default="OWN",
                        max_length=3,
                        verbose_name="sharing options",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="LPF",
                        max_length=3,
                        verbose_name="list selection strategy",
                    ),
                ),
                (
                    "include_pause_page",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("NON", "Key/Click responses only"),
                            ("AUD", "Audio + key/click responses"),
                            ("VID", "Video + key/click responses"),
                ...
                (
                    "general_onset",
                    models.IntegerField(
                        default=0, verbose_name="wait to enable key/click response (ms)"
                    ),
                ),
                (
                ...
                (
                    ...
                    tinymce.models.HTMLField(
                        ...
                        verbose_name="consent failed page template",
                    ),
                ),
                (
                ...
                (
                    ...
                    tinymce.models.HTMLField(
                        ...
                        verbose_name="pause page template",
                    ),
                ),
                (
                    "thank_you_page_tpl",
                    tinymce.models.HTMLField(
                        ...
                        verbose_name="standard end page template",
                    ),
                ),
                (
                    ...
                    tinymce.models.HTMLField(
                        ...
                        verbose_name="end page after discontinuation template",
                    ),
                ),
                (
                    "error_page_tpl",
                    tinymce.models.HTMLField(
                        default='{% extends "experiments/base.html" %} {% block title %}Error{% endblock %} {% block content %}\n<div class="container" id="information">\n    <div class="row">\n        <div class="col text-center">\n            <h1>Error</h1>\n        </div>\n    </div>\n    <div class="row">\n        <div class="col">\n            <div class="card">\n                <div class="card-body text-justify">\n                    <p class="card-text">\n                        An error has occurred. The study has now terminated.\n                    </p>\n                    <div class="alert alert-danger" role="alert">\n                        Error message\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n{% endblock %}',
                        verbose_name="error page template",
                    ),
                ),
                (
                    "assess_type",
                    models.CharField(
                        choices=[("COMP", "Comprehension"), ("PROD", "Production")],
                        default="COMP",
                        max_length=4,
                ...
                (
                    "num_words",
                    models.IntegerField(
                        default=25, verbose_name="vocabulary checklist length"
                    ),
                ),
                (
                    "typical_dev",
                    models.BooleanField(
                        ...
                        verbose_name="for typically-developing children",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instr_name",
                    models.CharField(max_length=200, verbose_name="instrument name"),
                ),
                (
                    "words_list",
                    models.CharField(
                        help_text="Only .csv files are supported.", max_length=250
                    ),
                ),
                (
                    "irt_params",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "global_timeout",
                    models.IntegerField(
                        default=300000, verbose_name="global timeout (ms)"
                    ),
                ),
                (
                    "exclude_list",
                    models.BooleanField(
                        default=False, verbose_name="do not include this list"
                    ),
                ),
                (
                    "experiment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "participant_id",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Participant Number"
                    ),
                ),
                (
                    "cdi_estimate",
                ...
                (
                    "resolution_w",
                    models.IntegerField(default=0, verbose_name="Resolution Width"),
                ),
                (
                    "resolution_h",
                    models.IntegerField(default=0, verbose_name="Resolution Height"),
                ),
                (
                    "experiment",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visual_onset",
                    models.IntegerField(default=0, verbose_name="visual onset (ms)"),
                ),
                (
                    "audio_onset",
                    models.IntegerField(default=0, verbose_name="audio onset (ms)"),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="maximum duration (ms)",
                    ),
                ),
                (
                    "record_media",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="enable eye-tracking",
                    ),
                ),
                (
                    "is_calibration",
                    models.BooleanField(
                        default=False,
                        help_text="This value will be ignored if the experiment is not set to record eye-tracking data.",
                        verbose_name="calibrate eye-tracker",
                    ),
                ),
                (
                    "calibration_points",
                    models.JSONField(
                        default=experiments.models.default_calibration_points,
                        help_text='These values will be ignored if "calibrate eye-tracker" is unchecked and the experiment is not set to record eye-tracking data.<br/>The duration for which each calibration point is shown is determined by dividing the <em>maximum duration</em> with the number of calibration points.',
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=experiments.models.visual_folder,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "response_yes",
                    models.CharField(default="Yes", max_length=50, verbose_name="yes"),
                ),
                (
                    "response_no",
                    models.CharField(default="No", max_length=50, verbose_name="no"),
                ),
                (
                    "experiment",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="experiments.question"
            ),
        ),
        migrations.AddField(
            model_name="answerbase",
