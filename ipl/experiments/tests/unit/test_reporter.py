...
class TestReporter:
    ...
    @patch('ipl.experiments.reporter.zipfile.ZipFile', DummyZipFile)
    @patch('ipl.experiments.reporter.os.makedirs')
    @patch('ipl.experiments.reporter.os.remove')
    @patch('ipl.experiments.reporter.os.path.exists')
    def test_reporter_init(self, mock_exists, mock_remove, mock_makedirs, experiment_factory):
        ...
        with patch('ipl.experiments.reporter.settings.REPORTS_ROOT', '/reports'):
        ...
        with patch('ipl.experiments.reporter.zipfile.ZipFile', DummyZipFile):
            with patch('ipl.experiments.reporter.settings.REPORTS_ROOT', '/reports'):
                with patch('ipl.experiments.reporter.os.makedirs'):
                    with patch('ipl.experiments.reporter.os.path.exists', return_value=False):
    ...
    @patch('ipl.experiments.reporter.pd.DataFrame.from_dict')
    @patch('ipl.experiments.reporter.ConsentQuestion')
    @patch('ipl.experiments.reporter.AnswerBase')
    @patch('ipl.experiments.reporter.CdiResult')
    ...
    @patch('ipl.experiments.reporter.OuterBlockItem')
    @patch('ipl.experiments.reporter.BlockItem')
    @patch('ipl.experiments.reporter.TrialResult')
    ...
    @patch('ipl.experiments.reporter.SubjectData')
            ...
            with patch('ipl.experiments.reporter.settings.REPORTS_ROOT', '/reports'):
                with patch('ipl.experiments.reporter.os.makedirs'):
                    with patch('ipl.experiments.reporter.os.path.exists', return_value=False):
                        ...
                        # Mock xlsxwriter
                        with patch('ipl.experiments.reporter.xlsxwriter.Workbook') as mock_workbook:
                            ...
                            with patch('ipl.experiments.reporter.shutil.rmtree'):
                                with patch('ipl.experiments.reporter.os.path.join', side_effect=lambda *args: '/'.join(args)):
