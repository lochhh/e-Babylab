...
> [!WARNING]
> **This is the final release of v1 (v1.0.2), which is no longer maintained.** Active development continues on [`main`](https://github.com/lochhh/e-Babylab/tree/main) as v2 (note: v2 is currently under active development and may be unstable). If you prefer a stable installation, stay on this version.
...
```bash
git clone -b v1.0.2 https://github.com/lochhh/e-Babylab.git
```
...
```bash
git clone -b v1.0.2 https://github.com/YOUR_GITHUB_USERNAME/e-Babylab.git
```
